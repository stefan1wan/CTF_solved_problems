...
0000147e <_putxval>:
    ...
    1490:	6f 76 00 1c 	mov.w	@(0x1c:16,r7),r6
    ...
    14a4:	0d 66       	mov.w	r6,r6
    14a6:	46 02       	bne	.+2 (0x14aa)
    14a8:	fe 01       	mov.b	#0x1,r6l

000014aa <.L10>:
    14aa:	0d 70       	mov.w	r7,r0
    14ac:	88 12       	add.b	#0x12,r0l
    14ae:	90 00       	addx	#0x0,r0h
    14b0:	79 01 15 3e 	mov.w	#0x153e,r1
    14b4:	40 28       	bra	.+40 (0x14de)

000014b6 <.L13>:
    14b6:	0d 35       	mov.w	r3,r5
    14b8:	0d 24       	mov.w	r2,r4
    14ba:	ed 0f       	and.b	#0xf,r5l
    14bc:	e5 00       	and.b	#0x0,r5h
    14be:	19 44       	sub.w	r4,r4
    14c0:	0d 14       	mov.w	r1,r4
    14c2:	09 54       	add.w	r5,r4
    14c4:	68 4c       	mov.b	@r4,r4l
    14c6:	68 8c       	mov.b	r4l,@r0
    14c8:	fc 04       	mov.b	#0x4,r4l
...
000014ca <.Llt1>:
    ...
    14d2:	8c ff       	add.b	#0xff,r4l
    14d4:	46 f4       	bne	.-12 (0x14ca)
    14d6:	0d 66       	mov.w	r6,r6
    14d8:	47 02       	beq	.+2 (0x14dc)

000014da <.L15>:
    14da:	1b 06       	subs	#1,r6

000014dc <.L12>:
    14dc:	1b 00       	subs	#1,r0

000014de <.L11>:
    14de:	0d 24       	mov.w	r2,r4
    14e0:	14 bc       	or.b	r3l,r4l
    14e2:	14 34       	or.b	r3h,r4h
    14e4:	0d 44       	mov.w	r4,r4
    14e6:	46 ce       	bne	.-50 (0x14b6)
    14e8:	0d 66       	mov.w	r6,r6
    14ea:	47 06       	beq	.+6 (0x14f2)
    14ec:	fc 30       	mov.b	#0x30,r4l
    14ee:	68 8c       	mov.b	r4l,@r0
    14f0:	40 e8       	bra	.-24 (0x14da)

000014f2 <.L17>:
    14f2:	0d 01       	mov.w	r0,r1
