 ...
 # options passed:  -nostdinc -D ___FreeBSD___ -D ARCH="mips16-elf"
 # mips16-elf.c -mips16 -msoft-float -auxbase-strip mips16-elf.s -g -O
...
$LVL13 = .
	...
	addiu	$16,1	 # str,
$LVL14 = .
	lb	$5,0($16)	 # D.1087, MEM[base: str_9, offset: 0B]
	bnez	$5,$L9	 #, D.1087,
$L8:
	.loc 1 50 0
	li	$2,0	 #,
...
$LVL18 = .
	...
	li	$2,0	 # tmp206,
	move	$3,$sp	 #,
	sb	$2,32($3)	 # tmp206, MEM[(char *)&buf + 16B]
	.loc 1 90 0
	bnez	$5,$L12	 #, value,
...
$L15:
	.loc 1 94 0
	li	$3,15	 # tmp208,
	move	$7,$5	 # D.1096, value
	and	$7,$3	 # D.1096, tmp208
	lw	$3,$L21	 # tmp207,
	addu	$3,$3,$7	 # tmp210, tmp207, D.1096
	lbu	$3,0($3)	 #,
	sb	$3,1($2)	 #, MEM[base: p_14, offset: 1B]
	.loc 1 95 0
...
$LVL26 = .
	...
	li	$3,48	 # tmp214,
	sb	$3,1($2)	 # tmp214, MEM[base: p_28, offset: 1B]
$LVL27 = .
	b	$L17	 #
$LVL28 = .
$L19:
...
$LC2:
	...
	.align	2
$LC3:
	.ascii	" This architecture is mips16-elf\012\000"
	.text
	.align	2
	.globl	main
$LFB5 = .
...
$LVL31 = .
	...
	li	$4,1	 #,
	move	$2,$28	 # tmp197,
	lw	$5,%gprel(data_value)($2)	 #, data_value
	.set	noreorder
	.set	nomacro
	jal	putxval	 #
	li	$6,0	 #,
