...
00001400 <_start>:
    ...
    1408:	dd 40 01 00 	call	1548 <_main>,[],0
    140c:	00 00 00 
    140f:	81          	mov	d0,d1
...
00001505 <.Loc.94.1>:
    1505:	8a 30       	mov	48,d2
    1507:	fc cf 7e 15 	mov	5502,d3
    150b:	00 00 
    150d:	ca 1a       	bra	1527 <.L16>

0000150f <.L18>:
    150f:	84          	mov	d1,d0
    1510:	f8 e0 0f    	and	15,d0
    1513:	f1 e2       	mov	d0,a2
    1515:	f1 6e       	add	d3,a2
    1517:	f0 42       	movbu	(a2),d0
    1519:	f8 50 01    	movbu	d0,(1,a0)
...
00001527 <.L16>:
    1527:	9a 01       	mov	1,a2
    1529:	f1 72       	add	a0,a2

0000152b <.LVL38>:
    152b:	a5 00       	cmp	0,d1
    152d:	c9 e2       	bne	150f <.L18>

0000152f <.Loc.93.1>:
    152f:	b5 00       	cmp	0,a1
    1531:	c8 07       	beq	1538 <.L22>

00001533 <.LVL39>:
    1533:	f8 58 01    	movbu	d2,(1,a0)

00001536 <.LVL40>:
    1536:	ca ed       	bra	1523 <.L20>

00001538 <.L22>:
    1538:	f1 dc       	mov	a3,d0
    153a:	85 01       	mov	1,d1

0000153c <.LVL42>:
    153c:	f1 59       	add	a2,d1
    153e:	cd 87 ff 00 	call	14c5 <_puts>,[],0
    1542:	00 

00001543 <.LVL43>:
    1543:	80 00       	mov	0,d0
    1545:	df f0 30    	ret	[d2,d3,a2,a3],48

00001548 <_main>:
    1548:	cf 80       	movm	[d2],(sp)

0000154a <.LCFI13>:
    154a:	f8 fe f0    	add	-16,sp

0000154d <.LCFI14>:
    154d:	80 01       	mov	1,d0
    154f:	fc cd 8f 15 	mov	5519,d1
    1553:	00 00 
    1555:	cd 70 ff 00 	call	14c5 <_puts>,[],0
    1559:	00 

0000155a <.LVL45>:
    155a:	8a 00       	mov	0,d2
    155c:	4a 0c       	mov	d2,(12,sp)
    155e:	80 01       	mov	1,d0
    1560:	fc a5 00 18 	mov	(1800 <_data_value>),d1
    1564:	00 00 
    1566:	cd 84 ff 00 	call	14ea <_putxval>,[],0
    156a:	00 

0000156b <.LVL46>:
    156b:	80 01       	mov	1,d0
    156d:	fc cd 9d 15 	mov	5533,d1
    1571:	00 00 
    1573:	cd 52 ff 00 	call	14c5 <_puts>,[],0
    1577:	00 

00001578 <.LVL47>:
    1578:	88          	mov	d2,d0
    1579:	cd 1d ff 00 	call	1496 <_exit>,[],0
    157d:	00 
