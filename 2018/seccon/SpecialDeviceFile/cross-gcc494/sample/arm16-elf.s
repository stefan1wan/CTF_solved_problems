...
@ options passed:  -nostdinc -D__ELF__ arm16-elf.c -mthumb
@ -mthumb-interwork -auxbase-strip arm16-elf.s -g -O -Wall -fno-builtin
...
.LFB25:
	...
	.loc 1 138 0
	ldr	r3, .L37	@ tmp113,
	ldr	r0, [r3]	@ static_value, static_value
	.loc 1 139 0
	@ sp needed	@
	bx	lr
.L38:
...
.LFB28:
	...
	str	r3, [sp]	@ tmp115, b
	.loc 1 158 0
	ldr	r0, [sp, #4]	@ D.1275, a
	ldr	r3, [sp]	@ D.1275, b
	add	r0, r0, r3	@ D.1275, D.1275, D.1275
	.loc 1 159 0
	add	sp, sp, #8	@,,
	@ sp needed	@
	bx	lr
...
.LVL44:
	.loc 1 205 0
	add	r0, r0, r3	@ D.1292, a0, a3
.LVL45:
	ldr	r3, [sp, #4]	@ tmp125, a5
.LVL46:
	mov	ip, r3	@ tmp125, tmp125
	add	r0, r0, ip	@ D.1292, tmp125
	ldr	r3, [sp, #12]	@ tmp127, a7
	mov	ip, r3	@ tmp127, tmp127
	add	r0, r0, ip	@ D.1292, tmp127
	.loc 1 206 0
	@ sp needed	@
	bx	lr
	.cfi_endproc
