...
__zero_reg__ = 1
 ...
 ;  -fzero-initialized-in-bss
	...
	.stabs	"/tmp/cross-gcc494/sample/",100,0,2,.Ltext0
...
.Ltext0:
	...
	.stabs	"structure:T(0,48)=s6a:(0,1),0,16;b:(0,1),16,16;c:(0,1),32,16;;",128,0,0,0
	.stabs	"null:F(0,47)",36,0,1,null
.global	null
	.type	null, @function
null:
	.stabd	46,0,0
...
.LM28:
	add r24,r22	 ;  D.1306, b
	adc r25,r23	 ;  D.1306, b
...
.Lscope19:
	...
	.stabs	"p:P(0,49)=*(0,50)=B(0,1)",64,0,96,24
.global	load
	.type	load, @function
load:
	.stabd	46,0,0
...
.LM39:
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	ld r24,Z	 ;  D.1315, *p_2(D)
	ldd r25,Z+1	 ;  D.1315, *p_2(D)
...
.Lscope20:
	...
	.stabd	78,0,0
	.stabs	"store:F(0,47)",36,0,101,store
	.stabs	"p:P(0,49)",64,0,101,24
.global	store
	.type	store, @function
store:
	.stabd	46,0,0
...
.LM42:
	...
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	std Z+1,r19	 ;  *p_2(D), tmp43
	st Z,r18	 ;  *p_2(D), tmp43
	ret
	.size	store, .-store
.Lscope21:
	...
	.stabs	"p:P(0,51)=*(0,52)=B(0,3)",64,0,106,24
.global	load_long
...
.LM44:
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	ld r22,Z	 ;  D.1318, *p_2(D)
	ldd r23,Z+1	 ;  D.1318, *p_2(D)
	ldd r24,Z+2	 ;  D.1318, *p_2(D)
	ldd r25,Z+3	 ;  D.1318, *p_2(D)
...
.Lscope22:
	...
	.stabd	78,0,0
	.stabs	"store_long:F(0,47)",36,0,111,store_long
	.stabs	"p:P(0,51)",64,0,111,24
.global	store_long
...
.LM47:
	...
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	st Z,r20	 ;  *p_2(D), tmp43
	std Z+1,r21	 ;  *p_2(D), tmp43
	std Z+2,r22	 ;  *p_2(D), tmp43
	std Z+3,r23	 ;  *p_2(D), tmp43
	ret
...
.Lscope23:
	...
	.stabs	"p:P(0,53)=*(0,48)",64,0,122,24
.global	member
...
.LM49:
	...
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	std Z+3,r19	 ;  p_2(D)->b, tmp45
	std Z+2,r18	 ;  p_2(D)->b, tmp45
...
.Lscope24:
	...
	.stabd	78,0,0
	.stabs	"get_static_value_addr:F(0,54)=*(0,1)",36,0,131,get_static_value_addr
...
.Lscope26:
	...
	.stabd	78,0,0
	.stabs	"set_static_value:F(0,47)",36,0,141,set_static_value
...
.Lscope27:
	...
	.stabd	78,0,0
	.stabs	"set_stack:F(0,47)",36,0,148,set_stack
.global	set_stack
...
.LM60:
	...
	.stabs	"a:(0,50)",128,0,150,1
	.stabs	"b:(0,50)",128,0,151,3
...
.LM64:
	ldd r18,Y+1	 ;  D.1328, a
	ldd r19,Y+2	 ;  D.1328, a
	ldd r24,Y+3	 ;  D.1328, b
	ldd r25,Y+4	 ;  D.1328, b
...
/* epilogue start */
	...
	.stabs	"a:(0,50)",128,0,156,1
	.stabs	"b:(0,50)",128,0,157,3
	.stabn	192,0,0,.LFBB29-.LFBB29
	.stabn	224,0,0,.Lscope29-.LFBB29
.Lscope29:
	.stabs	"",36,0,0,.Lscope29-.LFBB29
	.stabd	78,0,0
	.stabs	"call_self:F(0,47)",36,0,161,call_self
.global	call_self
...
.Lscope33:
	...
	.stabd	78,0,0
	.stabs	"call_pointer:F(0,47)",36,0,182,call_pointer
	.stabs	"f:P(0,55)=*(0,56)=f(0,1)",64,0,182,24
.global	call_pointer
...
.LM86:
	...
	ret
.L40:
	.stabn	68,0,196,.LM87-.LFBB36
.LM87:
	ldi r24,0	 ;  sum
	ldi r25,0	 ;  sum
	.stabn	68,0,200,.LM88-.LFBB36
.LM88:
	ret
	.size	loop, .-loop
...
/* stack size = 4 */
.L__stack_usage = 4
	.stabn	68,0,205,.LM90-.LFBB37
.LM90:
	add r24,r18	 ;  D.1344, a3
	adc r25,r19	 ;  D.1344, a3
	add r24,r14	 ;  D.1344, a5
	adc r25,r15	 ;  D.1344, a5
	.stabn	68,0,206,.LM91-.LFBB37
.LM91:
	add r24,r10	 ; , a7
	adc r25,r11	 ; , a7
/* epilogue start */
...
.Lscope38:
	...
	.stabd	78,0,0
	.stabs	"direct:F(0,47)",36,0,214,direct
.global	direct
	.type	direct, @function
direct:
	.stabd	46,0,0
	.stabn	68,0,215,.LM95-.LFBB39
.LM95:
.LFBB39:
/* prologue: function */
/* frame size = 0 */
...
.Lscope39:
	...
	.stabd	78,0,0
	.stabs	"binary:F(0,47)",36,0,222,binary
.global	binary
	.type	binary, @function
binary:
	.stabd	46,0,0
	.stabn	68,0,223,.LM97-.LFBB40
.LM97:
.LFBB40:
/* prologue: function */
/* frame size = 0 */
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,224,.LM98-.LFBB40
.LM98:
/* #APP */
 ;  224 "avr-elf.c" 1
	.align 4
 ;  0 "" 2
	.stabn	68,0,225,.LM99-.LFBB40
.LM99:
 ;  225 "avr-elf.c" 1
	.int 0x0
 ;  0 "" 2
