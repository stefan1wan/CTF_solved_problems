...
__zero_reg__ = 1
 ...
 ;  -fzero-initialized-in-bss -mint8
...
.Ltext0:
	...
	.stabs	"structure:T(0,48)=s3a:(0,1),0,8;b:(0,1),8,8;c:(0,1),16,8;;",128,0,0,0
...
.LM44:
	mov r30,r24	 ; , p
	mov r31,r25	 ; , p
	ld r24,Z	 ;  D.1318, *p_2(D)
	ldd r25,Z+1	 ;  D.1318, *p_2(D)
...
.LM64:
	ldd r25,Y+1	 ;  D.1328, a
	ldd r24,Y+2	 ;  D.1328, b
