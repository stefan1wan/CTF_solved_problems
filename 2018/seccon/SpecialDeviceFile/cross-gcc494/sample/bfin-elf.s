...
.LVL21:
	...
	R0 = 1 (X);	// tmp59,
.LVL22:
	[P2+4] = R0;	// p_2(D)->b, tmp59
	.loc 1 125 0
	R0 = [P2+8];	// p_2(D)->c, p_2(D)->c
	.loc 1 126 0
	rts;
.LFE23:
...
.LVL44:
	...
	R1 = [SP+12];	// a3, a3
.LVL45:
	R0 = R0 + R1;	// D.1283, a0, a3
.LVL46:
	R1 = [SP+20];	// a5, a5
	R0 = R0 + R1;	// D.1283, D.1283, a5
	R1 = [SP+28];	// a7, a7
	R0 = R0 + R1;	// D.1283, D.1283, a7
	.loc 1 206 0
	rts;
.LFE36:
