...
.LVL15:
	.loc 1 124 0
	moveq 1,$r9	;#,
	move.d $r9,[$r10+4]	;#, p_2(D)->b
	.loc 1 126 0
	move.d [$r10+8],$r10	;# p_2(D)->c,
.LVL16:
	ret
	nop
.LFE23:
...
.LCFI1:
	...
	move.d $r9,[$sp]	;#, b
	.loc 1 158 0
	move.d [$sp+4],$r10	;# a, D.1214
	move.d [$sp],$r9	;# b, D.1214
	.loc 1 159 0
	add.d $r9,$r10	;# D.1214,
	ret
	addq 8,$sp	;#,
...
.LVL37:
	.loc 1 205 0
	add.d $r13,$r10	;# a3, D.1230
.LVL38:
	add.d [$sp+4],$r10	;# a5, D.1230
	.loc 1 206 0
	add.d [$sp+12],$r10	;# a7,
	ret
	nop
