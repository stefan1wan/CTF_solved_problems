...
; -fverbose-asm -fzero-initialized-in-bss -macc-8 -malloc-cc -mcond-exec
; -mcond-move -mdword -mfpr-64 -mgpr-64 -mhard-float -mlinked-fp -mmedia
...
.LVL5:
.LM30:
	add gr8,gr9,gr8	; b, a, D.1333
.LVL6:
	add gr8,gr10,gr8	; c, D.1333, D.1333
.LM31:
	ret
.LFE14:
	.size	add3, .-add3
...
.LM55:
	setlos #1, gr4	;, tmp182
	sti gr4, @(gr8,4)	; p_2(D)->b, tmp182
.LM56:
	ldi @(gr8,8), gr8	; p_2(D)->c, p_2(D)->c
.LVL22:
.LM57:
	ret
.LFE23:
...
.LM73:
	ldi @(fp,-4), gr8	; a, D.1355
	ldi @(fp,-8), gr4	; b, D.1355
	add gr8,gr4,gr8	; D.1355, D.1355, D.1355
.LM74:
	ldi @(fp,8), gr5	;,
	ld @(fp,gr0), fp	;,
	addi sp,#24,sp	;,,
...
.LVL29:
	call return_arg1	;
.LVL30:
	sti gr8, @(gr16,#gprel12(static_value))	; static_value, D.1362
.LM86:
	mov gr18, gr8	; b,
	ldi @(sp,0), gr18	;,
.LVL31:
...
.LVL37:
.LM95:
	cmpi gr8,#0,icc0	;, n, tmp183
	ble icc0,0,.L40	;, tmp183,
	setlos #0, gr5	;, sum
	setlos #0, gr4	;, i
.LVL38:
.L39:
...
.LM97:
	addi gr4,#1,gr4	;, i, i
.LVL40:
	cmp gr4,gr8,icc0	; n, i, tmp184
	bne icc0,2,.L39	;, tmp184,
	bra .L38	;
.LVL41:
.L40:
.LM98:
...
.LVL44:
.LM101:
	add gr8,gr11,gr11	; a3, a0, D.1371
.LVL45:
	add gr11,gr13,gr13	; a5, D.1371, D.1371
.LVL46:
	ldi @(sp,4), gr4	; a7, a7
	add gr13,gr4,gr8	; a7, D.1371, D.1371
.LVL47:
.LM102:
	ret
.LFE36:
