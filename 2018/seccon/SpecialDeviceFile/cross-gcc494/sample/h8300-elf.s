...
_store:
	mov.w	#255,r2	;#, tmp19
	mov.w	r2,@r0	;# tmp19, *p_2(D)
	rts
	.size	_store, .-_store
	.align 1
	.global _load_long
_load_long:
	mov.w	@(2,r0),r1	;# *p_2(D), D.1202
	mov.w	@r0,r0	;# *p_2(D), D.1202
	rts
...
_member:
	mov.w	#1,r2	;#, tmp21
	mov.w	r2,@(2,r0)	;# tmp21, p_2(D)->b
	mov.w	@(4,r0),r0	;# p_2(D)->c,
	rts
...
_use_stack:
	...
	mov.b	#-1,r2l	;#, tmp23
	mov.w	r2,@r7	;# tmp23, b
	mov.w	@(2,r7),r0	;# a, D.1212
	mov.w	@r7,r2	;# b, D.1212
	add.w	r2,r0	;# D.1212,
	adds	#2,r7	;#,
	adds	#2,r7	;#,
	rts
...
_many_args:
	mov.w	@(2,r7),r2	;# a3, a3
	add.w	r2,r0	;# a3, D.1228
	mov.w	@(6,r7),r2	;# a5, a5
	add.w	r2,r0	;# a5, D.1228
