...
.LVL2:
	.loc 1 68 0
	mov.w	r1,r0	; a, D.1185
	add.w	r2,r0	; b, D.1185
	.loc 1 69 0
	rts
.LFE13:
	.size	_add, .-_add
...
.LCFI0:
	.loc 1 73 0
	mov.w	r1,r0	; a, D.1187
	add.w	r2,r0	; b, D.1187
	add.w	5[fb],r0	; c, D.1187
	.loc 1 74 0
	exitd
.LFE14:
	.size	_add3, .-_add3
...
.LVL13:
	...
	mov.w	#1,r0	;,
	mov.w	r1,a0	; p,
	mov.w	r0,2[a0]	;, p_2(D)->b
	.loc 1 125 0
	add.w	#4,a0	;,
	mov.w	[a0],r0	; p_2(D)->c, p_2(D)->c
	.loc 1 126 0
	rts
.LFE23:
...
.LCFI2:
	...
	mov.w	#255,-4[fb]	;, b
	.loc 1 158 0
	mov.w	-2[fb],r0	; a, D.1209
	add.w	-4[fb],r0	; b, D.1209
	.loc 1 159 0
	exitd
.LFE28:
...
.LVL20:
	jsr.a	_return_arg1	; return_arg1
.LVL21:
	mov.w	r0,_static_value	; D.1216, static_value
	.loc 1 180 0
	mov.w	-2[fb],r0	; %sfp,
	exitd
.LFE32:
...
.LVL22:
	.loc 1 184 0
	mov.w	r1,a0	; f,
	push.w a0 | jsr.a	m32c_jsri16	; *f_2(D)
.LVL23:
	.loc 1 185 0
	rts
.LFE33:
...
.LCFI4:
	.loc 1 205 0
	mov.w	r1,r0	; a0, D.1226
	add.w	7[fb],r0	; a3, D.1226
	add.w	11[fb],r0	; a5, D.1226
	add.w	15[fb],r0	; a7, D.1226
	.loc 1 206 0
	exitd
.LFE36:
