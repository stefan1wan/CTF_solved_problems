...
00fe156c <loop>:
  fe156c:	b0 c0 00 06 	blez r0,fe1584 <loop+0x18>
  fe1570:	65 00 64 00 	ldi r5,#0 -> ldi r4,#0
  fe1574:	05 a4 f0 00 	add r5,r4 || nop
  fe1578:	44 01 f0 00 	addi r4,#1 || nop
  fe157c:	b4 10 ff fe 	bne r4,r0,fe1574 <loop+0x8>
  fe1580:	7f 02 f0 00 	bra fe1588 <loop+0x1c> || nop
  fe1584:	65 00 f0 00 	ldi r5,#0 || nop
  fe1588:	10 85 f0 00 	mv r0,r5 || nop
  fe158c:	1f ce f0 00 	jmp lr || nop

00fe1590 <many_args>:
  fe1590:	00 a3 f0 00 	add r0,r3 || nop
  fe1594:	a4 cf 00 04 	ld r4,@(4,sp)
  fe1598:	00 a4 f0 00 	add r0,r4 || nop
  fe159c:	a4 cf 00 0c 	ld r4,@(12,sp)
  fe15a0:	00 a4 1f ce 	add r0,r4 -> jmp lr

00fe15a4 <call_many_args>:
  fe15a4:	2e 7f 4f f0 	push lr -> addi sp,#-16
  fe15a8:	64 04 24 4f 	ldi r4,#4 -> st r4,@sp
  fe15ac:	64 05 f0 00 	ldi r4,#5 || nop
  fe15b0:	a4 4f 00 04 	st r4,@(4,sp)
  fe15b4:	64 06 f0 00 	ldi r4,#6 || nop
  fe15b8:	a4 4f 00 08 	st r4,@(8,sp)
  fe15bc:	64 07 f0 00 	ldi r4,#7 || nop
  fe15c0:	a4 4f 00 0c 	st r4,@(12,sp)
  fe15c4:	60 00 61 01 	ldi r0,#0 -> ldi r1,#1
  fe15c8:	62 02 63 03 	ldi r2,#2 -> ldi r3,#3
  fe15cc:	fe ff ff f1 	bl fe1590 <many_args>
  fe15d0:	4f 10 2e ef 	addi sp,#16 -> pop lr
  fe15d4:	1f ce f0 00 	jmp lr || nop

00fe15d8 <direct>:
  fe15d8:	70 00 1f ce 	nop -> jmp lr

00fe15dc <binary>:
  fe15dc:	70 00 f0 00 	nop || nop
