...
add3:
	.frame	r1,0,r15		# vars= 0, regs= 0, args= 0
	.mask	0x00000000
	addk	r3,r5,r6	 # D.1187, a, b
	rtsd	r15, 8
	
	addk	r3,r3,r7	 #, D.1187, c
	.end	add3
$Lfe15:
...
use_stack:
	...
	addik	r3,r0,255	# 0xff	 #,
	swi	r3,r1,8	 # b,
	lwi	r4,r1,4	 # a, D.1209
	lwi	r3,r1,8	 # b, D.1209
	addk	r3,r4,r3	 #, D.1209, D.1209
	rtsd	r15,8 
...
many_args:
	.frame	r1,0,r15		# vars= 0, regs= 0, args= 0
	.mask	0x00000000
	addk	r5,r5,r8	 # D.1225, a0, a3
	addk	r10,r5,r10	 # D.1225, D.1225, a5
	lwi	r3,r1,32	 # a7, a7
	rtsd	r15, 8
	
	addk	r3,r10,r3	 #, D.1225, a7
	.end	many_args
$Lfe37:
