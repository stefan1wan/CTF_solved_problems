...
00fe151f <.L36>:
  fe151f:	80 01       	mov	1,d0

00fe1521 <.LVL35>:
  fe1521:	e4          	add	d1,d0
  fe1522:	de 00 00    	retf	[],0

00fe1525 <_loop>:
  fe1525:	f1 e0       	mov	d0,a0

00fe1527 <.LVL37>:
  fe1527:	a0 00       	cmp	0,d0
  fe1529:	c3 0e       	ble	fe1537 <.L40>
  fe152b:	80 00       	mov	0,d0
...
00fe152f <.Loc.197.1>:
  fe152f:	44          	inc	d1
  fe1530:	f1 91       	cmp	a0,d1
  fe1532:	c9 fc       	bne	fe152e <.L39>
  fe1534:	de 00 00    	retf	[],0

00fe1537 <.L40>:
  fe1537:	80 00       	mov	0,d0

00fe1539 <.LVL43>:
  fe1539:	de 00 00    	retf	[],0

00fe153c <_many_args>:
  fe153c:	59 10       	mov	(16,sp),d1

00fe153e <.LVL45>:
  fe153e:	e4          	add	d1,d0

00fe153f <.LVL46>:
  fe153f:	59 18       	mov	(24,sp),d1
  fe1541:	e1          	add	d0,d1

00fe1542 <.Loc.206.1>:
  fe1542:	58 20       	mov	(32,sp),d0
  fe1544:	e4          	add	d1,d0
  fe1545:	de 00 00    	retf	[],0

00fe1548 <_call_many_args>:
  fe1548:	f8 fe dc    	add	-36,sp

00fe154b <.LCFI8>:
  fe154b:	80 02       	mov	2,d0
  fe154d:	42 0c       	mov	d0,(12,sp)
  fe154f:	80 03       	mov	3,d0
  fe1551:	42 10       	mov	d0,(16,sp)
  fe1553:	80 04       	mov	4,d0
  fe1555:	42 14       	mov	d0,(20,sp)
  fe1557:	80 05       	mov	5,d0
  fe1559:	42 18       	mov	d0,(24,sp)
  fe155b:	80 06       	mov	6,d0
  fe155d:	42 1c       	mov	d0,(28,sp)
  fe155f:	80 07       	mov	7,d0
  fe1561:	42 20       	mov	d0,(32,sp)
  fe1563:	80 00       	mov	0,d0
  fe1565:	85 01       	mov	1,d1
  fe1567:	cd d5 ff 00 	call	fe153c <_many_args>,[],0
  fe156b:	00 

00fe156c <.LVL47>:
  fe156c:	df 00 24    	ret	[],36

00fe156f <_direct>:
  fe156f:	cb          	nop	
  fe1570:	de 00 00    	retf	[],0
