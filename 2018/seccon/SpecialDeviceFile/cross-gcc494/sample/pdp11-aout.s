;# GNU C (GCC) version 4.9.4 (pdp11-aout)
...
;# -funit-at-a-time -fverbose-asm -fzero-initialized-in-bss -m45
;# -mbcopy-builtin -mbranch-cheap -mdec-asm -mfloat64 -mfpu -mint16
...
_add:
	...
	.globl _add3
_add3:
	mov 02(sp), r0	;# a, D.1185
	add 04(sp), r0	;# b, D.1185
	add 06(sp), r0	;# c,
	rts pc
	.even
	.globl _add_two
...
_or_one:
	...
	.globl _load
_load:
	mov @02(sp), r0	;# *p_2(D), D.1194
	rts pc
	.even
	.globl _store
_store:
	mov $0377, @02(sp)	;#, *p_2(D)
	rts pc
	.even
	.globl _load_long
_load_long:
...
_store_long:
	mov 02(sp), r0	;# p, p
	mov $010442,(r0)	;#, *p_2(D)
	mov $031504,02(r0)	;#, *p_2(D)
	rts pc
	.even
	.globl _member
_member:
	mov 02(sp), r0	;# p, p
	mov $01, 02(r0)	;#, p_2(D)->b
	mov 04(r0), r0	;# p_2(D)->c,
	rts pc
	.even
...
L_38:
	...
	.globl _many_args
_many_args:
	mov 02(sp), r0	;# a0, D.1223
	add 010(sp), r0	;# a3, D.1223
	add 014(sp), r0	;# a5, D.1223
	add 020(sp), r0	;# a7,
	rts pc
	.even
