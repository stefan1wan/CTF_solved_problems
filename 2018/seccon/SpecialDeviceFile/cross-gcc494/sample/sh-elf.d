...
00fe1424 <_return_long>:
  ...
  fe142e:	99 aa       	mov.w	fe1586 <_call_many_args+0x6>,r9	! 2f12
...
00fe1468 <_or_one>:
  fe1468:	e0 01       	mov	#1,r0
  fe146a:	00 0b       	rts	
  fe146c:	20 4b       	or	r4,r0
...
00fe14cc <_use_stack>:
  ...
  fe14d4:	1f 10       	mov.l	r1,@(0,r15)
  fe14d6:	50 f1       	mov.l	@(4,r15),r0
  fe14d8:	51 f0       	mov.l	@(0,r15),r1
...
00fe1520 <_call_complex2>:
  ...
  fe152c:	d1 03       	mov.l	fe153c <_call_complex2+0x1c>,r1	! fe1804 <_static_value>
...
00fe1558 <_loop>:
  fe1558:	44 15       	cmp/pl	r4
  fe155a:	8b 07       	bf	fe156c <_loop+0x14>
  fe155c:	e0 00       	mov	#0,r0
  fe155e:	e1 00       	mov	#0,r1
  fe1560:	30 1c       	add	r1,r0
  fe1562:	71 01       	add	#1,r1
  fe1564:	31 40       	cmp/eq	r4,r1
  fe1566:	8b fb       	bf	fe1560 <_loop+0x8>
  fe1568:	a0 01       	bra	fe156e <_loop+0x16>
  fe156a:	00 09       	nop	
  fe156c:	e0 00       	mov	#0,r0
  fe156e:	00 0b       	rts	
  fe1570:	00 09       	nop	

00fe1572 <_many_args>:
  fe1572:	37 4c       	add	r4,r7
  fe1574:	51 f1       	mov.l	@(4,r15),r1
  fe1576:	60 73       	mov	r7,r0
  fe1578:	30 1c       	add	r1,r0
  fe157a:	51 f3       	mov.l	@(12,r15),r1
  fe157c:	00 0b       	rts	
  fe157e:	30 1c       	add	r1,r0

00fe1580 <_call_many_args>:
  fe1580:	4f 22       	sts.l	pr,@-r15
  fe1582:	7f f0       	add	#-16,r15
  fe1584:	e1 04       	mov	#4,r1
  fe1586:	2f 12       	mov.l	r1,@r15
  fe1588:	e1 05       	mov	#5,r1
  fe158a:	1f 11       	mov.l	r1,@(4,r15)
  fe158c:	e1 06       	mov	#6,r1
  fe158e:	1f 12       	mov.l	r1,@(8,r15)
  fe1590:	e1 07       	mov	#7,r1
  fe1592:	1f 13       	mov.l	r1,@(12,r15)
  fe1594:	e4 00       	mov	#0,r4
  fe1596:	e5 01       	mov	#1,r5
  fe1598:	e6 02       	mov	#2,r6
  fe159a:	d0 03       	mov.l	fe15a8 <_call_many_args+0x28>,r0	! fe1572 <_many_args>
  fe159c:	40 0b       	jsr	@r0
  fe159e:	e7 03       	mov	#3,r7
  fe15a0:	7f 10       	add	#16,r15
  fe15a2:	4f 26       	lds.l	@r15+,pr
  fe15a4:	00 0b       	rts	
  fe15a6:	00 09       	nop	
  fe15a8:	00 fe       	mov.l	@(r0,r15),r0
  fe15aa:	15 72       	mov.l	r7,@(8,r5)
