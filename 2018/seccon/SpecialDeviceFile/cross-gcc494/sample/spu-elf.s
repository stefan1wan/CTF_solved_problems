	.file	"spu-elf.c"
# GNU C (GCC) version 4.9.4 (spu-elf)
...
# -fverbose-asm -fzero-initialized-in-bss -maddress-space-conversion
# -mbranch-hints -mdual-nops -mea32 -merror-reloc -msafe-dma -msafe-hints
# -msmall-mem
...
.LVL45:
	.loc 1 205 0
	a	$3,$3,$6	# D.2033, a0, a3
.LVL46:
	a	$2,$3,$8	# D.2033, D.2033, a5
	.loc 1 206 0
	a	$3,$2,$10	#, D.2033, a7
	bi	$lr
.LFE36:
