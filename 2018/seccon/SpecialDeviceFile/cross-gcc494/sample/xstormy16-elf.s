...
; GNU C (GCC) version 4.9.4 (xstormy16-elf)
...
.LVL19:
	.loc 1 108 0
	mov.w r3,(r2,2)	; D.1206, *p_2(D)
	mov.w r2,(r2)	; D.1206, *p_2(D)
.LVL20:
	.loc 1 109 0
	ret
.LFE21:
...
.LVL22:
	.loc 1 124 0
	mov.w r7,#1	;,
	mov.w (r2,2),r7	; p_2(D)->b,
	.loc 1 125 0
	mov.w r2,(r2,4)	; p_2(D)->c, p_2(D)->c
.LVL23:
	.loc 1 126 0
	ret
.LFE23:
...
.LCFI1:
	...
	mov.w (sp,-2),r7	; b,
	.loc 1 158 0
	mov.w r2,(sp,-4)	; D.1216, a
	mov.w r7,(sp,-2)	; D.1216, b
	add r2,r7	; D.1216, D.1216
	.loc 1 159 0
	dec sp,#3	;,
	ret
.LFE28:
...
.LVL31:
	...
	mov.w (r7),r2	; static_value, D.1223
	.loc 1 180 0
	mov r2,r10	;, b
	pop r10	;
.LVL32:
...
.LVL44:
	...
	add r5,r2	; D.1232, a0
.LVL45:
	add r7,r5	; D.1232, D.1232
.LVL46:
	mov.w r6,(sp,-8)	; a7, a7
.LVL47:
	mov r2,r7	; D.1232, D.1232
.LVL48:
	add r2,r6	; D.1232, a7
	.loc 1 206 0
	ret
